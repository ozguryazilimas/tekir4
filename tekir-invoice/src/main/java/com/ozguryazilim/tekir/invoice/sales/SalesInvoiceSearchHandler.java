 ...
 */
@Dependent
public class SalesInvoiceSearchHandler extends AbstractFeatureSearchHandler{
    ...
    public List<FeatureSearchResult> search(String searchText, Map<String,Object> params ) {
        ...
        QueryDefinition<SalesInvoice, SalesInvoiceViewModel> query = new QueryDefinition<>();
        ...
        for( SalesInvoiceViewModel o : repository.browseQuery(query) ){
            FeatureSearchResult sr = new FeatureSearchResult(
            		SalesInvoiceFeature.class.getSimpleName(),
                    o.getVoucherNo(),
                    o.getId(),
                    o.getTopic(),
                    o.getInfo()
