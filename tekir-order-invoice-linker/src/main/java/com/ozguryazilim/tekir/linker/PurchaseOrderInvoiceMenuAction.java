...
import com.ozguryazilim.tekir.order.purchase.PurchaseOrderHome;
...
@Named
@RequestScoped
public class PurchaseOrderInvoiceMenuAction implements Serializable {

    @Inject
    private PurchaseOrderHome orderHome;
    ...
    public Class<? extends ViewConfig> newInvoice() {
        ...
        PurchaseOrder entity = (PurchaseOrder) orderHome.getEntity();
