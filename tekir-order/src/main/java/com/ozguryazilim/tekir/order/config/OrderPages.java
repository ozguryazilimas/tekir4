...
public interface OrderPages extends Pages {
    ...
    interface Sales extends OrderPages {
        ...
        @Navigation(label = "module.caption.SalesOrderBrowse",
        ...
        class SalesOrderMasterView implements Sales {
        }
    ...
    interface Purchase extends OrderPages {
        ...
        @Navigation(label = "module.caption.PurchaseOrderBrowse",
                icon = "flaticon-speech-bubble",
        ...
        class PurchaseOrderMasterView implements Purchase {
        }
