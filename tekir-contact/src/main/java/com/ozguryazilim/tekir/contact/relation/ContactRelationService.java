...
public class ContactRelationService implements Serializable {
    ...
    private ContactRelationViewModel getWorkCorporationRelation() {
        ...
        result.setName(Messages.getMessage("contact.label.Workplace"));
        result.setWeigth(-10);
    ...
    private ContactRelationViewModel getParentCorporationRelation() {
        ...
        result.setId(-2l);
        result.setCode("INTERNAL");
        result.setName(Messages.getMessage("contact.label.ParentCompany"));
        result.setWeigth(-10);
        //Sadece kurumlar hedeflenebilir.
        result.setTargetRoles("CORPORATION");
        return result;
    ...
    private ContactRelationViewModel getSubCorporationRelation() {
        ...
        result.setId(-3l);
        result.setCode("INTERNAL");
        result.setName(Messages.getMessage("contact.label.SubsidiaryCompany"));
        result.setWeigth(-5);
        //Sadece kurumlar hedeflenebilir.
        result.setTargetRoles("CORPORATION");
        return result;
    ...
    private ContactRelationViewModel getEmployeeRelation() {
        ...
        result.setId(-4l);
        result.setCode("INTERNAL");
        result.setName(Messages.getMessage("contact.label.Employee"));
        result.setWeigth(-1);
        //Sadece kurumlar hedeflenebilir.
