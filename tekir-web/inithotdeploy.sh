...
rm -rf WEB-INF/lib/telve-core-4.0.0.Beta4.jar
#rm -rf WEB-INF/lib/telve-core-model-4.0.0.Beta4.jar
#rm -rf WEB-INF/lib/telve-idm-model-4.0.0.Beta4.jar
rm -rf WEB-INF/lib/telve-idm-4.0.0.Beta4.jar
rm -rf WEB-INF/lib/telve-layout-4.0.0.Beta4.jar
#rm -rf WEB-INF/lib/telve-keycloak-4.0.0.Beta4.jar
#rm -rf WEB-INF/lib/telve-bpm-4.0.0.Beta4.jar
#rm -rf WEB-INF/lib/telve-jcr-4.0.0.Beta4.jar
...
#ln -s ~/git/telve4/telve-core-model/target/classes/ WEB-INF/lib/telve-core-model-4.0.0.Beta4.jar
#ln -s ~/git/telve4/telve-idm-model/target/classes/ WEB-INF/lib/telve-idm-model-4.0.0.Beta4.jar
ln -s ~/git/telve4/telve-idm/target/classes/ WEB-INF/lib/telve-idm-4.0.0.Beta4.jar
ln -s ~/git/telve4/telve-layout/target/classes/ WEB-INF/lib/telve-layout-4.0.0.Beta4.jar
#ln -s ~/git/telve4/telve-keycloak/target/classes/ WEB-INF/lib/telve-keycloak-4.0.0.Beta4.jar
#ln -s ~/git/telve4/telve-bpm/target/classes/ WEB-INF/lib/telve-bpm-4.0.0.Beta4.jar
#ln -s ~/git/telve4/telve-jcr/target/classes/ WEB-INF/lib/telve-jcr-4.0.0.Beta4.jar
