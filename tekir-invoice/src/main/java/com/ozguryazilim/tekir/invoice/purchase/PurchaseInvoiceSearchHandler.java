 ...
 */
@Dependent
public class PurchaseInvoiceSearchHandler extends AbstractFeatureSearchHandler{
    ...
    public List<FeatureSearchResult> search(String searchText, Map<String,Object> params ) {
        ...
        QueryDefinition<PurchaseInvoice, PurchaseInvoiceViewModel> query = new QueryDefinition<>();
        ...
        for( PurchaseInvoiceViewModel o : repository.browseQuery(query) ){
            FeatureSearchResult sr = new FeatureSearchResult(
            		PurchaseInvoiceFeature.class.getSimpleName(),
                    o.getVoucherNo(),
                    o.getId(),
                    o.getTopic(),
                    o.getInfo()
