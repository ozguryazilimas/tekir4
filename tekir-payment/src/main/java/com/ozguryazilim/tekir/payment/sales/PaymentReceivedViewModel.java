...
public class PaymentReceivedViewModel extends PaymentViewModel{
    ...
    public PaymentReceivedViewModel(Long id, Process process, Contact account, String code, String voucherNo, String info, String referenceNo, Date date, String owner, VoucherState state, String stateReason, String stateInfo, VoucherGroup group, String topic, FinanceAccount financeAccount, Currency currency, BigDecimal amount) {
        super(id, process, account, code, voucherNo, info, referenceNo, date, owner, state, stateReason, stateInfo, group, topic, financeAccount, currency, amount);
    }
    ...
    public PaymentReceivedViewModel(Long id, Long processId, String processNo, Long accountId, String accountName, Class<? extends Contact> accountType, String code, String voucherNo, String info, String referenceNo, Date date, String owner, VoucherState state, String stateReason, String stateInfo, Long groupId, String groupNo, String topic, Long financeId, String financeName, Currency currency, BigDecimal amount) {
        super(id, processId, processNo, accountId, accountName, accountType, code, voucherNo, info, referenceNo, date, owner, state, stateReason, stateInfo, groupId, groupNo, topic, financeId, financeName, currency, amount);
    }
