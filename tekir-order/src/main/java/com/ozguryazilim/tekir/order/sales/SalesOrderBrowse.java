...
public class SalesOrderBrowse extends VoucherBrowseBase<SalesOrder, SalesOrderViewModel> {
    ...
    protected void buildQueryDefinition(QueryDefinition<SalesOrder, SalesOrderViewModel> queryDefinition) {
        queryDefinition
                ...
                .addColumn(new MoneyColumn<>(SalesOrder_.total, SalesOrder_.currency, "general.label.Total"), true)
        ...
        queryDefinition
                ...
                .addFilter(new BigDecimalFilter<>(SalesOrder_.total, "general.label.Total"))
