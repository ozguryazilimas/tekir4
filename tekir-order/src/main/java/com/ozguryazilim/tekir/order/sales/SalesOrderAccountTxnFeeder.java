 ...
 */
@Dependent
public class SalesOrderAccountTxnFeeder implements Serializable{
    @Inject
    private AccountTxnService accountTxnService;
    
    
    public void feed(@Observes @EntityQualifier(entity = SalesOrder.class) @After EntityChangeEvent event) {
