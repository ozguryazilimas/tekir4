 ...
 * @author oyas
 */
public abstract class InvoiceBrowse<E extends Invoice, V extends InvoiceViewModel> extends VoucherBrowseBase<E, V> {
    ...
    protected void buildQueryDefinition(QueryDefinition<E, V> queryDefinition) {
        queryDefinition
                ...
                .addColumn(new MoneyColumn<>(Invoice_.total, Invoice_.currency, "general.label.Total"), true)
        ...
        queryDefinition
                ...
                .addFilter(new BigDecimalFilter<>(Invoice_.total, "general.label.Total"))
