...
public class SalesInvoiceHome extends VoucherFormBase<SalesInvoice> implements VoucherCommodityItemEditorListener<InvoiceItem> {
    ...
    public void calculateSummaries() {
        SummaryCalculator<SalesInvoice, InvoiceItem, InvoiceSummary> sc = new SummaryCalculator();
