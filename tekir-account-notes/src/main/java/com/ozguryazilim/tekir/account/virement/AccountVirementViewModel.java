...
public class AccountVirementViewModel extends VoucherViewModel{
    ...
    public AccountVirementViewModel(Long id, Contact fromAccount, Contact toAccount, Currency currency, BigDecimal amount, List<String> tags, String voucherNo, String info, String referenceNo, Date date, String owner, VoucherState state, String stateReason, String stateInfo, VoucherGroup group, String topic) {
