 ...
 */
@Dependent
public class AccountDebitNoteSearchHandler extends AbstractFeatureSearchHandler{
    ...
    public List<FeatureSearchResult> search(String searchText, Map<String,Object> params ) {
        ...
        QueryDefinition<AccountDebitNote, AccountDebitNoteViewModel> query = new QueryDefinition<>();
        ...
        for( AccountDebitNoteViewModel o : repository.browseQuery(query) ){
            FeatureSearchResult sr = new FeatureSearchResult(
            		AccountDebitNoteFeature.class.getSimpleName(),
                    o.getVoucherNo(),
                    o.getId(),
                    o.getTopic(),
                    o.getInfo()
