...
public interface InvoicePages extends Pages {
    interface Sales extends InvoicePages {
        ...
        @Navigation(label = "module.caption.SalesInvoiceBrowse",
                icon = "flaticon-invoice-1",
        ...
        class SalesInvoiceMasterView implements Sales {
        }
    ...
    interface Purchase extends InvoicePages {
        ...
        @Navigation(label = "module.caption.PurchaseInvoiceBrowse",
                icon = "flaticon-invoice-1",
        ...
        class PurchaseInvoiceMasterView implements Purchase {
        }
    }
}
