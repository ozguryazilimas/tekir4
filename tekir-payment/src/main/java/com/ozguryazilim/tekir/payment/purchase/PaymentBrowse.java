...
public class PaymentBrowse extends VoucherBrowseBase<Payment, PaymentViewModel>{
    ...
    @Override
    protected void buildQueryDefinition(QueryDefinition<Payment, PaymentViewModel> queryDefinition) {
        queryDefinition
                ...
                .addColumn(new SubTextColumn<>(Payment_.bankCashAccount, BankCashAccount_.name, "bankCashAccount.label.Account"), true)
                ...
                .addColumn(new MoneyColumn<>(Payment_.amount, Payment_.currency, "general.label.Total"), true)
        ...
        queryDefinition
                ...
                .addFilter(new BigDecimalFilter<>(Payment_.amount, "general.label.Total"))
                .addFilter(new SubStringFilter<>(VoucherProcessBase_.account, Contact_.name, "voucher.label.Account"))
                .addFilter(new SubStringFilter<>(Payment_.bankCashAccount, BankCashAccount_.name, "bankCashAccount.label.Account"))
