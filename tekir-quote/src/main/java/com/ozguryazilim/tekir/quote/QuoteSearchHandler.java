 ...
 */
@Dependent
public class QuoteSearchHandler extends AbstractFeatureSearchHandler{
    ...
    public List<FeatureSearchResult> search(String searchText, Map<String,Object> params ) {
        ...
        QueryDefinition<Quote, QuoteViewModel> query = new QueryDefinition<>();
        ...
        for( QuoteViewModel o : repository.browseQuery(query) ){
            FeatureSearchResult sr = new FeatureSearchResult(
                    QuoteFeature.class.getSimpleName(),
                    o.getVoucherNo(),
                    o.getId(),
                    o.getTopic(),
                    o.getInfo()
