...
public class EmployeeLeaveViewModel extends VoucherViewModel{
	...
	public EmployeeLeaveViewModel(Long id, List<String> tags, String voucherNo, String info, String referenceNo,
								  Date date, String owner, VoucherState state, String stateReason, String stateInfo,
								  Long groupId, String groupNo, String topic, Long employeeId, String employeeName,
								  Boolean paid, Boolean annual, Date startDate, Date endDate, Integer leaveDay) {
		super(id, tags, voucherNo, info, referenceNo, date, owner, state,
				stateReason, stateInfo, groupId,groupNo, topic);
