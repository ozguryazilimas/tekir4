...
import com.ozguryazilim.tekir.recruit.config.RecruitPages.ApplicantPages;
...
@Page(type = PageType.BROWSE, page = ApplicantPages.ApplicantBrowse.class)
@Page(type = PageType.EDIT, page = ApplicantPages.Applicant.class)
