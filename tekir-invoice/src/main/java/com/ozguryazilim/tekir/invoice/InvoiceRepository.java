 ...
 * @author oyas
 */
public abstract class InvoiceRepository<E extends Invoice, V extends InvoiceViewModel> extends VoucherRepositoryBase<E, V> {
    ...
    public List<V> browseQuery(QueryDefinition queryDefinition) {
        ...
        Join<E, VoucherGroup> joinGroup = from.join(PurchaseInvoice_.group, JoinType.LEFT);
